...
const _monsterPals = [
    Uint8Array.from([ // junkie
        ...
        0x76, 0x0B, 0x34, 0x03, 0x55, 0x09, 0x30, 0x04, 0x60, 0x07, 0x55, 0x04, 0x77, 0x07, UINT8_MAX, 0x0F
    ]),
    Uint8Array.from([ // mercenaire
        0x00, 0x00, 0x86, 0x0C, 0x66, 0x09, 0x44, 0x08, 0xFC, 0x05, 0xA2, 0x02, 0x49, 0x05, 0x02, 0x00,
        0x14, 0x02, 0x37, 0x04, 0x25, 0x03, 0x38, 0x06, 0xAF, 0x0C, 0x6F, 0x09, 0x4C, 0x07, UINT8_MAX, 0x0F
    ]),
    ...
    Uint8Array.from([ // glue
        ...
        0x10, 0x05, 0x20, 0x08, 0x00, 0x02, 0x30, 0x09, 0x55, 0x0B, UINT8_MAX, 0x0F, 0x33, 0x0A, UINT8_MAX, 0x0F
    ])
]
