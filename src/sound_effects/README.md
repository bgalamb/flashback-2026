...
This folder is now the source-of-truth for the decoded sound-effect assets.
During `dev` and `build`, it is copied into `DATA/sound_effects/` for runtime loading.
