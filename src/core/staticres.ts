...
const _offsetsTableDOS = Uint16Array.from([
	0x0000, 0x0000, 0x0001, 0x0003, 0x0001, 0x0004, uint16Max, 0x0000, 0x0001, 0x0002,
	0x0003, 0x0000, 0x0004, 0x0000, uint16Max, 0x0100, uint16Max, 0x0000, 0x0006, 0x0000,
	0x0001, 0x0001, uint16Max, 0x0000, uint16Max, 0x0200, 0x8007, 0x0000, 0x0003, 0x0001,
	0x0001, 0x000B, 0x0001, 0x0005, 0x0009, 0x0000, 0x0001, 0x0006, uint16Max, 0x0000,
	0x000B, 0x0000, 0x0001, 0x000A, uint16Max, 0x0001, uint16Max, 0x0002, uint16Max, 0x0000,
	0x000D, 0x0004, 0x000D, 0x0000, 0x000D, 0x0001, 0x000D, 0x0002, 0x000D, 0x0003,
	uint16Max, 0x0000, uint16Max, 0x0001, 0x0001, 0x000C, 0x0001, 0x000D, 0x0001, 0x000E,
	...
	0x000F, 0x0005, uint16Max, 0x0000, 0x0004, 0x0001, 0x0011, 0x0000, 0x0001, 0x0009,
	0x0012, 0x0000, uint16Max, 0x0000, 0x0014, 0x0000, 0x0015, 0x0000, 0x0016, 0x0000,
	0x0016, 0x0001, uint16Max, 0x0012, 0x0017, 0x0000, 0x0001, 0x0011, 0x0018, 0x0000,
...
const _cineSceneIdToCutPairsDOS = (() => {
	const table = []
	for (let sceneId = 0; sceneId < ((_offsetsTableDOS.length / 2) >> 0); ++sceneId) {
		const cutNameIndex = _offsetsTableDOS[sceneId * 2]
		const cutName = cutNameIndex === uint16Max ? null : _namesTableDOS[cutNameIndex & uint8Max]
...
const _musicTable = Uint8Array.from([
	0x10, 0x15, 0x15, uint8Max, 0x15, 0x19, 0x0F, uint8Max, 0x15, 0x04, 0x15, uint8Max, uint8Max, 0x00, 0x19, 0x15,
	0x15, 0x0D, 0x15, 0x0D, 0x18, 0x13, uint8Max, uint8Max, uint8Max, 0x14, 0x14, 0x14, 0x14, 0x14, uint8Max, uint8Max,
	0x13, 0x13, 0x13, 0x13, 0x15, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x13, 0x13, 0x11, uint8Max, 0x03,
	0x0E, 0x13, 0x12, uint8Max, 0x06, 0x07, 0x0A, 0x0A, 0x15, 0x05, 0x13, 0x02, 0x15, 0x09, 0x17, 0x08,
	0x0B, 0x0C, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, uint8Max, uint8Max, uint8Max
])



const _gameLevels = [
	{ name: "level1", name2: "level1", cutsceneId: 0x00, sound: 1, track: 3 },
	{ name: "level2", name2: "level2", cutsceneId: 0x2F, sound: 1, track: 4 },
	{ name: "level3", name2: "level3", cutsceneId: uint16Max, sound: 3, track: 5 },
	{ name: "level4", name2: "level4_1", cutsceneId: 0x34, sound: 3, track: 6 },
	{ name: "level4", name2: "level4_2", cutsceneId: 0x39, sound: 3, track: 6 },
	{ name: "level5", name2: "level5_1", cutsceneId: 0x35, sound: 4, track: 7 },
	{ name: "level5", name2: "level5_2", cutsceneId: uint16Max, sound: 4, track: 7 },
	{ name: "level10", name2: "level10", cutsceneId: 0x00, sound: 1, track: 3 }
]
...
const _stringsTableEN = Uint8Array.from([
	...
	0x77, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x49, 0x27, 0x6D, 0x20, 0x4A, 0x61, 0x63, 0x6B, 0x2E, 0x59,
	0x6F, 0x75, 0x27, 0x72, 0x65, 0x0A, 0x61, 0x66, 0x74, 0x65, 0x72, 0x20, 0x73, 0x6F, 0x6D, 0x65,
	0x20, 0x66, 0x61, 0x6C, 0x73, 0x65, 0x0A, 0x70, 0x61, 0x70, 0x65, 0x72, 0x73, 0x3F, 0x0B, uint8Max,
	...
	0x2E, 0x0B, uint8Max, 0xEB, 0xEC, 0x31, 0x35, 0x30, 0x30, 0x20, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74,
	0x73, 0x21, 0x0B, uint8Max, 0xE9, 0xEA, 0x31, 0x35, 0x30, 0x30, 0x3F, 0x3F, 0x3F, 0x0B, uint8Max, 0xEB,
	...
	0x2E, 0x0B, uint8Max, 0xE9, 0xEA, 0x42, 0x75, 0x74, 0x20, 0x49, 0x20, 0x64, 0x6F, 0x6E, 0x27, 0x74,
	0x0A, 0x68, 0x61, 0x76, 0x65, 0x20, 0x65, 0x6E, 0x6F, 0x75, 0x67, 0x68, 0x2E, 0x2E, 0x2E, 0x0B,
	uint8Max, 0xEB, 0xEC, 0x47, 0x6F, 0x20, 0x74, 0x6F, 0x20, 0x74, 0x68, 0x65, 0x0A, 0x45, 0x6D, 0x70,
	...
	0x6D, 0x6F, 0x6E, 0x65, 0x79, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x49, 0x20, 0x6B, 0x6E, 0x6F, 0x77,
	...
	0x65, 0x20, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x65, 0x2E, 0x0B, uint8Max, 0xE9, 0xEA, 0x57, 0x68, 0x65,
	0x72, 0x65, 0x20, 0x63, 0x61, 0x6E, 0x20, 0x49, 0x20, 0x66, 0x69, 0x6E, 0x64, 0x0A, 0x74, 0x68,
	0x69, 0x73, 0x20, 0x66, 0x72, 0x69, 0x65, 0x6E, 0x64, 0x3F, 0x0B, uint8Max, 0xEB, 0xEC, 0x47, 0x6F,
	...
	0x65, 0x0A, 0x6D, 0x65, 0x61, 0x6E, 0x21, 0x00, uint8Max, 0xEB, 0xEC, 0x49, 0x20, 0x64, 0x6F, 0x6E,
	0x27, 0x74, 0x20, 0x6B, 0x6E, 0x6F, 0x77, 0x0A, 0x61, 0x6E, 0x79, 0x74, 0x68, 0x69, 0x6E, 0x67,
	0x20, 0x6D, 0x6F, 0x72, 0x65, 0x2C, 0x0A, 0x73, 0x6F, 0x6E, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x43,
	...
	0x65, 0x20, 0x62, 0x61, 0x72, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x47, 0x6F, 0x20, 0x74, 0x6F, 0x20,
	...
	0x66, 0x6F, 0x72, 0x20, 0x79, 0x6F, 0x75, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x44, 0x6F, 0x6E, 0x27,
	...
	uint8Max, 0xEB, 0xEC, 0x49, 0x20, 0x64, 0x6F, 0x6E, 0x27, 0x74, 0x20, 0x6B, 0x6E, 0x6F, 0x77, 0x0A,
	0x61, 0x6E, 0x79, 0x74, 0x68, 0x69, 0x6E, 0x67, 0x20, 0x65, 0x6C, 0x73, 0x65, 0x2E, 0x00, uint8Max,
	...
	0x65, 0x72, 0x6D, 0x69, 0x74, 0x2E, 0x0B, uint8Max, 0xEB, 0xEC, 0x4E, 0x6F, 0x2C, 0x20, 0x69, 0x74,
	...
	0x74, 0x2E, 0x0B, uint8Max, 0xEB, 0xEC, 0x47, 0x6F, 0x6F, 0x64, 0x2E, 0x2E, 0x2E, 0x4F, 0x2E, 0x6B,
	...
	0x6D, 0x69, 0x74, 0x2E, 0x0B, uint8Max, 0xEB, 0xEC, 0x4E, 0x6F, 0x2C, 0x20, 0x69, 0x74, 0x27, 0x73,
	...
	0x63, 0x6B, 0x2E, 0x0B, uint8Max, 0xEB, 0xEC, 0x4F, 0x68, 0x20, 0x79, 0x65, 0x61, 0x68, 0x3F, 0x20,
	0x4A, 0x61, 0x63, 0x6B, 0x27, 0x73, 0x0A, 0x6E, 0x6F, 0x74, 0x20, 0x68, 0x65, 0x72, 0x65, 0x2E,
	0x0B, uint8Max, 0xE9, 0xEA, 0x49, 0x27, 0x76, 0x65, 0x20, 0x62, 0x65, 0x65, 0x6E, 0x20, 0x73, 0x65,
	0x6E, 0x74, 0x0A, 0x62, 0x79, 0x20, 0x6D, 0x79, 0x20, 0x66, 0x72, 0x69, 0x65, 0x6E, 0x64, 0x0A,
	0x49, 0x61, 0x6E, 0x2E, 0x0B, uint8Max, 0xEB, 0xEC, 0x4F, 0x2E, 0x6B, 0x2E, 0x20, 0x4A, 0x61, 0x63,
	0x6B, 0x27, 0x73, 0x0A, 0x77, 0x61, 0x69, 0x74, 0x69, 0x6E, 0x67, 0x20, 0x66, 0x6F, 0x72, 0x20,
	0x79, 0x6F, 0x75, 0x0A, 0x6F, 0x75, 0x74, 0x73, 0x69, 0x64, 0x65, 0x2E, 0x00, uint8Max, 0xEB, 0xEC,
	...
	0x20, 0x64, 0x72, 0x69, 0x6E, 0x6B, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x50, 0x61, 0x70, 0x65, 0x72,
	0x73, 0x20, 0x70, 0x6C, 0x65, 0x61, 0x73, 0x65, 0x2E, 0x00, 0x49, 0x27, 0x6D, 0x20, 0x74, 0x68,
	0x65, 0x0A, 0x6D, 0x65, 0x73, 0x73, 0x65, 0x6E, 0x67, 0x65, 0x72, 0x2E, 0x0B, uint8Max, 0xEB, 0xEC,
	...
	0x72, 0x20, 0x74, 0x68, 0x65, 0x20, 0x63, 0x61, 0x72, 0x64, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x54,
	...
	0x52, 0x54, 0x48, 0x3F, 0x0B, uint8Max, 0xEB, 0xEC, 0x54, 0x68, 0x65, 0x20, 0x63, 0x6F, 0x73, 0x74,
	...
	0x61, 0x74, 0x68, 0x20, 0x54, 0x6F, 0x77, 0x65, 0x72, 0x2E, 0x0B, uint8Max, 0xE9, 0xEA, 0x44, 0x65,
	0x61, 0x74, 0x68, 0x20, 0x54, 0x6F, 0x77, 0x65, 0x72, 0x3F, 0x0B, uint8Max, 0xEB, 0xEC, 0x59, 0x65,
	...
	0x65, 0x74, 0x2E, 0x0B, uint8Max, 0xE9, 0xEA, 0x4F, 0x2E, 0x6B, 0x2E, 0x43, 0x61, 0x6E, 0x20, 0x79,
	0x6F, 0x75, 0x0A, 0x73, 0x75, 0x70, 0x70, 0x6C, 0x79, 0x20, 0x66, 0x61, 0x6C, 0x73, 0x65, 0x0A,
	0x70, 0x61, 0x70, 0x65, 0x72, 0x73, 0x3F, 0x0B, uint8Max, 0xEB, 0xEC, 0x4E, 0x6F, 0x20, 0x70, 0x72,
	...
	0x6E, 0x20, 0x79, 0x6F, 0x75, 0x72, 0x0A, 0x70, 0x6F, 0x63, 0x6B, 0x65, 0x74, 0x2E, 0x0B, uint8Max,
	...
	0x20, 0x6E, 0x65, 0x78, 0x74, 0x20, 0x74, 0x69, 0x6D, 0x65, 0x2E, 0x2E, 0x2E, 0x0B, uint8Max, 0xEB,
	...
	0x68, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x57, 0x65, 0x6C, 0x63, 0x6F, 0x6D, 0x65, 0x20, 0x74, 0x6F,
	...
	uint8Max, 0xE9, 0xEA, 0x54, 0x68, 0x61, 0x6E, 0x6B, 0x20, 0x79, 0x6F, 0x75, 0x2E, 0x00, uint8Max, 0xEB,
	0xEC, 0x48, 0x61, 0x76, 0x65, 0x20, 0x61, 0x20, 0x6E, 0x69, 0x63, 0x65, 0x0A, 0x64, 0x61, 0x79,
	0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x59, 0x6F, 0x75, 0x20, 0x6D, 0x75, 0x73, 0x74, 0x20, 0x68, 0x61,
	...
	0x72, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x49, 0x20, 0x64, 0x6F, 0x6E, 0x27, 0x74, 0x20, 0x68, 0x61,
	0x76, 0x65, 0x0A, 0x74, 0x69, 0x6D, 0x65, 0x2E, 0x00, 0x47, 0x6F, 0x6F, 0x64, 0x20, 0x6D, 0x6F,
	0x72, 0x6E, 0x69, 0x6E, 0x67, 0x2E, 0x0B, uint8Max, 0xEB, 0xEC, 0x47, 0x6F, 0x6F, 0x64, 0x20, 0x6D,
	0x6F, 0x72, 0x6E, 0x69, 0x6E, 0x67, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x49, 0x27, 0x76, 0x65, 0x20,
	...
	0x00, 0x47, 0x6F, 0x6F, 0x64, 0x20, 0x6D, 0x6F, 0x72, 0x6E, 0x69, 0x6E, 0x67, 0x2E, 0x0B, uint8Max,
	0xEB, 0xEC, 0x47, 0x6F, 0x6F, 0x64, 0x20, 0x6D, 0x6F, 0x72, 0x6E, 0x69, 0x6E, 0x67, 0x2E, 0x00,
	uint8Max, 0xEB, 0xEC, 0x59, 0x65, 0x73, 0x2C, 0x49, 0x20, 0x6B, 0x6E, 0x6F, 0x77, 0x20, 0x68, 0x69,
	...
	0x61, 0x0A, 0x77, 0x6F, 0x72, 0x6B, 0x20, 0x70, 0x65, 0x72, 0x6D, 0x69, 0x74, 0x2E, 0x0B, uint8Max,
	...
	0x79, 0x6F, 0x75, 0x72, 0x20, 0x49, 0x44, 0x0A, 0x63, 0x61, 0x72, 0x64, 0x2E, 0x00, uint8Max, 0xEB,
	0xEC, 0x48, 0x45, 0x4C, 0x50, 0x2E, 0x2E, 0x2E, 0x48, 0x45, 0x4C, 0x50, 0x2E, 0x2E, 0x2E, 0x00,
	uint8Max, 0xEB, 0xEC, 0x48, 0x65, 0x6C, 0x70, 0x20, 0x6D, 0x65, 0x20, 0x79, 0x6F, 0x75, 0x6E, 0x67,
	...
	uint8Max, 0xEB, 0xEC, 0x54, 0x68, 0x61, 0x6E, 0x6B, 0x73, 0x2E, 0x59, 0x6F, 0x75, 0x20, 0x6A, 0x75,
	0x73, 0x74, 0x0A, 0x73, 0x61, 0x76, 0x65, 0x64, 0x20, 0x6D, 0x79, 0x20, 0x6C, 0x69, 0x66, 0x65,
	0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x54, 0x6F, 0x20, 0x67, 0x65, 0x74, 0x20, 0x74, 0x6F, 0x20, 0x4E,
	...
	0x2D, 0x47, 0x20, 0x62, 0x65, 0x6C, 0x74, 0x2E, 0x0B, uint8Max, 0xE9, 0xEA, 0x57, 0x68, 0x65, 0x72,
	0x65, 0x20, 0x63, 0x61, 0x6E, 0x20, 0x49, 0x20, 0x66, 0x69, 0x6E, 0x64, 0x0A, 0x6F, 0x6E, 0x65,
	0x3F, 0x0B, uint8Max, 0xEB, 0xEC, 0x4E, 0x6F, 0x77, 0x2C, 0x20, 0x49, 0x20, 0x63, 0x61, 0x6E, 0x0A,
	0x73, 0x65, 0x6C, 0x6C, 0x20, 0x79, 0x6F, 0x75, 0x20, 0x6F, 0x6E, 0x65, 0x3A, 0x0A, 0x35, 0x30,
	0x30, 0x20, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x42, 0x6F,
	...
	0x27, 0x64, 0x20, 0x6C, 0x69, 0x6B, 0x65, 0x20, 0x61, 0x0A, 0x77, 0x6F, 0x72, 0x6B, 0x20, 0x70,
	0x65, 0x72, 0x6D, 0x69, 0x74, 0x2E, 0x0B, uint8Max, 0xEB, 0xEC, 0x46, 0x69, 0x72, 0x73, 0x74, 0x20,
	...
	uint8Max, 0xEB, 0xEC, 0x54, 0x72, 0x75, 0x73, 0x74, 0x20, 0x6D, 0x65, 0x2C, 0x73, 0x6F, 0x6E, 0x2C,
	...
	uint8Max, 0xEB, 0xEC, 0x4C, 0x65, 0x61, 0x64, 0x20, 0x6F, 0x6E, 0x2C, 0x79, 0x6F, 0x75, 0x6E, 0x67,
	...
	0x6E, 0x74, 0x65, 0x72, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x54, 0x68, 0x61, 0x6E, 0x6B, 0x20, 0x79,
	...
	0x61, 0x6E, 0x67, 0x65, 0x72, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x57, 0x65, 0x6C, 0x6C, 0x20, 0x74,
	...
	0x68, 0x3F, 0x0B, uint8Max, 0xEB, 0xEC, 0x35, 0x30, 0x2C, 0x30, 0x30, 0x30, 0x20, 0x63, 0x72, 0x65,
	0x64, 0x69, 0x74, 0x73, 0x2E, 0x00, uint8Max, 0xEB, 0xEC, 0x49, 0x20, 0x73, 0x63, 0x72, 0x61, 0x74,
...
const _voicesOffsetsTable = Uint16Array.from([
	...
	0x01B6, 0x01BE, 0x01C6, 0x01CC, 0x01D4, uint16Max, uint16Max, uint16Max, uint16Max, uint16Max,
...
const _pgeModkeystable = Uint8Array.from([
	0x40, 0x10, 0x20
])
...
const _protectionCodeData = Uint8Array.from([
	...
	0x39, 0xF9, 0xB9, 0x99, 0xB9, 0x79, 0x19, 0x59, 0xC9, 0x47, 0x79, 0x39, 0x7F, uint8Max, 0xF9, 0xB7,
	...
	0x39, 0x79, 0x5F, uint8Max, 0x27, 0xF9, 0x99, 0x99, 0x47, 0xB7, 0x37, 0x27, 0xF9, 0x79, 0x87, 0x3F,
	0x97, 0x99, 0x47, 0xB7, 0x59, 0x99, 0xB9, 0xD9, 0xC9, 0x49, 0xB7, 0x39, 0x37, 0xD9, 0xF9, 0xB7,
	0x37, 0x37, 0x39, 0xF9
])

const _protectionWordData = Uint8Array.from([
	0x01, 0x01, 0x02, 0x05, 0xD7, 0x77, 0x3F, 0xF7, 0x27, 0x7F, uint8Max, 0x1F, 0xF7, 0x51, 0x51, 0x51,
	0x51, 0x00, 0x01, 0x01, 0x05, 0x03, 0xDF, uint8Max, 0xF7, 0x9F, 0x7F, 0x51, 0x51, 0x51, 0x51, 0x51,
	0x51, 0x51, 0x51, 0x00, 0x01, 0x01, 0x05, 0x06, 0x97, 0x67, 0xF7, 0x3F, 0xF7, 0x1F, 0x51, 0x51,
	0x51, 0x51, 0x51, 0x51, 0x51, 0x00, 0x01, 0x02, 0x02, 0x07, 0x17, 0xD7, 0x97, 0x87, uint8Max, 0x5F,
	...
	0x51, 0x00, 0x02, 0x02, 0x05, 0x01, 0x1F, 0xF7, 0x37, uint8Max, 0xB7, 0xF7, 0xF7, 0x9F, 0x51, 0x51,
	...
	0x51, 0x51, 0x51, 0x00, 0x03, 0x03, 0x04, 0x01, 0xE7, uint8Max, 0x7F, 0xD7, 0x7F, 0xC7, 0xA7, 0x27,
	0x9F, 0x51, 0x51, 0x51, 0x51, 0x00, 0x04, 0x01, 0x01, 0x05, 0xF7, 0xCF, 0xF7, 0x9F, 0x51, 0x51,
	0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x00, 0x04, 0x01, 0x02, 0x01, 0x9F, uint8Max, 0x1F, 0x1F,
	0xA7, uint8Max, 0x27, 0x77, 0xC7, 0x27, 0xB7, 0x51, 0x51, 0x00, 0x04, 0x01, 0x03, 0x05, 0x17, 0x1F,
	...
	0x01, 0x03, 0xC7, 0x27, 0x7F, 0x1F, 0xA7, 0x77, uint8Max, 0x97, 0x7F, 0xC7, 0xA7, 0x27, 0x51, 0x00,
	...
	0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x00, 0x06, 0x01, 0x03, 0x02, 0x9F, uint8Max, 0x1F, 0x3F,
	...
	0x05, 0x06, 0x9F, 0xC7, 0x7F, uint8Max, 0xD7, 0x7F, 0xC7, 0xA7, 0x27, 0x9F, 0x51, 0x51, 0x51, 0x00,
	...
	0x03, 0x04, 0x9F, uint8Max, 0x17, 0xBF, 0xD7, 0xCF, 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x51, 0x00
])


const _protectionPal = Uint8Array.from([
	// DOS
	0x00, 0x00, 0x00, 0x42, 0x00, 0x63, 0x00, 0x00, 0x0F, uint8Max, 0x0F, 0xF0, 0x07, 0x77, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	// Amiga
	0x00, 0x00, 0x03, 0x04, 0x06, 0x05, 0x00, 0x00, 0x04, 0x44, 0x05, 0x55, 0x06, 0x66, 0x07, 0x77,
	0x08, 0x88, 0x09, 0x99, 0x0A, 0xAA, 0x0B, 0xBB, 0x0C, 0xCC, 0x0D, 0xDD, 0x0E, 0xEE, 0x0F, uint8Max
])
...
const _conradPaletteVariant1 = Uint8Array.from([
	...
	0x52, 0x07, 0x41, 0x06, 0x30, 0x06, 0x76, 0x0C, 0x14, 0x09, 0x25, 0x0B, 0x88, 0x08, uint8Max, 0x0F
])
...
const _conradPaletteVariant2 = Uint8Array.from([
	...
	0x14, 0x08, 0x03, 0x06, 0x02, 0x04, 0x43, 0x09, 0x02, 0x06, 0x02, 0x07, 0x6A, 0x0A, uint8Max, 0x0F
])
...
const _musicData68 = Uint8Array.from([
	0x00, 0x1B, 0x00, 0x07, 0x00, 0x0C, 0x00, 0x18, uint8Max, 0xF4, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const _musicData73 = Uint8Array.from([
	0x00, 0x41, 0x00, 0x06, 0x00, 0x0C, 0x00, 0x18, 0x00, 0x0C, uint8Max, 0xF4, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const _musicDataSample1 = Uint8Array.from([
	...
	0x73, 0x50, 0xC4, 0x96, 0xE7, 0x15, 0xFC, 0xFD, 0x12, 0x0C, 0xE6, 0xEF, 0x0F, 0xF8, 0xE3, uint8Max,
	0x47, 0x4E, 0x08, 0xD2, 0xEA, 0x27, 0x3B, 0x22, 0x09, 0x03, uint8Max, 0xF2, 0xF3, 0x03, 0x00, 0xEA,
	...
	0x2C, 0x28, 0x24, 0x20, 0x1C, 0x16, 0x0B, 0x02, uint8Max, 0xF9, 0xEB, 0xE0, 0xD6, 0xCC, 0xC3, 0xBA,
	0xB0, 0xA6, 0xA0, 0x99, 0x92, 0x8C, 0x88, 0x88, 0x88, 0x85, 0x83, 0x85, 0x89, 0x8C, 0x91, 0x9A,
	0xA2, 0xAB, 0xB2, 0xBB, 0xC7, 0xD6, 0xE3, 0xF1, uint8Max, 0x0C, 0x17, 0x23, 0x2D, 0x39, 0x45, 0x50,
	...
	0x06, 0x05, 0x04, 0x02, 0x01, 0xFE, 0xFC, 0xFC, uint8Max, 0x00, 0xFE, 0xFB, 0xFA, 0xFA, 0xFC, 0xFD,
	...
	0xB6, 0xBF, 0xC7, 0xD1, 0xDC, 0xE7, 0xF3, uint8Max, 0x0B, 0x16, 0x1F, 0x29, 0x33, 0x3B, 0x44, 0x4D,
	...
	0xD8, 0xDB, 0xDF, 0xE3, 0xE7, 0xEB, 0xF0, 0xF6, 0xFB, uint8Max, 0x03, 0x08, 0x0C, 0x0E, 0x11, 0x12,
	...
	0xDA, 0xDF, 0xE5, 0xEA, 0xEF, 0xF5, 0xFA, uint8Max, 0x04, 0x08, 0x0B, 0x0D, 0x10, 0x12, 0x12, 0x11,
	...
	0xDF, 0xE5, 0xEC, 0xF3, 0xF9, uint8Max, 0x04, 0x09, 0x0C, 0x0F, 0x11, 0x12, 0x12, 0x11, 0x10, 0x0D,
	...
	0xD8, 0xDF, 0xE7, 0xEE, 0xF5, 0xFB, uint8Max, 0x04, 0x08, 0x0B, 0x0D, 0x0E, 0x0E, 0x0E, 0x0C, 0x09,
...
const _musicDataSample3 = Uint8Array.from([
	...
	0x03, 0xFC, 0xE9, 0xE1, 0xE2, 0xF5, uint8Max, 0x0E, 0x23, 0x29, 0x13, 0xD5, 0x98, 0x8B, 0xA1, 0xBB,
	...
	0x0D, 0x0D, 0x0F, 0x01, 0xFA, 0x06, 0x30, 0x5C, 0x75, 0x6F, 0x3A, 0x00, 0xF1, uint8Max, 0xFA, 0xE2,
	...
	0xC6, 0xCB, 0xC0, 0xAB, 0xAB, 0xD6, 0x23, 0x7F, 0x7F, 0x7F, 0x3E, 0xEB, 0xCA, 0xE6, uint8Max, 0xF6,
	0xE8, 0xEB, 0xE7, 0xE5, 0xF6, 0x14, 0x22, 0x24, 0x17, 0xDC, 0x9D, 0x91, 0xB2, 0xDC, 0xED, 0xE2,
	0xEE, 0x21, 0x5A, 0x6E, 0x62, 0x3A, 0xFE, 0xCA, 0xBD, 0xAD, 0x93, 0x9D, 0xC7, 0xE8, uint8Max, 0x24,
	...
	0xBC, 0xBE, 0xD5, 0xD4, 0xD3, 0xED, uint8Max, 0x00, 0x13, 0x68, 0x7F, 0x7F, 0x61, 0xE1, 0x90, 0x83,
	...
	0x9B, 0x89, 0xC1, 0x1E, 0x3F, 0x29, 0x14, 0x03, 0xF8, 0x17, 0x4C, 0x6C, 0x5F, 0x33, 0x0F, uint8Max,
	...
	0x1C, 0xFC, 0xBE, 0x85, 0x84, 0xA8, 0xE0, 0x18, 0x2C, 0x04, 0xD7, 0xC2, 0xD1, 0xED, uint8Max, 0x02,
	...
	0x5F, 0x4E, 0x18, 0xDE, 0xA1, 0x84, 0x86, 0xA4, 0xC8, 0xE9, 0xF6, uint8Max, 0x0E, 0x21, 0x42, 0x4E,
	0x35, uint8Max, 0xC1, 0xC0, 0xED, 0x20, 0x55, 0x67, 0x3E, 0x14, 0xED, 0xD9, 0xCC, 0xC2, 0xB5, 0xA9,
	...
	0x31, 0xF6, 0xAF, 0x8C, 0x9B, 0xB1, 0xD0, 0xF2, uint8Max, 0x01, 0x03, 0x1E, 0x4A, 0x66, 0x60, 0x2E,
	...
	0x42, 0x3F, 0x2A, 0x0E, 0xF8, 0xED, 0xF5, uint8Max, 0x01, 0x04, 0xF0, 0xC7, 0xA8, 0xA1, 0xC0, 0x09,
	0x37, 0x29, 0x0B, 0x01, 0xFD, 0xFE, uint8Max, 0xF4, 0xD9, 0xD1, 0xE9, 0xFA, 0x07, 0x21, 0x31, 0x34,
	...
	0x24, 0x1D, 0x31, 0x3F, 0x2C, 0x11, uint8Max, 0xF5, 0xFC, 0x15, 0x14, 0xF2, 0xEF, 0x0B, 0x1A, 0x14,
	0x03, 0xFB, 0xFB, 0xFC, 0xED, 0xDD, 0xE7, 0xFE, 0x18, 0x28, 0x1D, 0xF6, 0xE3, 0x0D, 0x2E, 0x28,
	0x18, 0x0E, 0x02, 0xFC, 0xFE, uint8Max, 0xFC, 0x01, 0xEE, 0xD0, 0xB3, 0xA8, 0xBF, 0xFC, 0x27, 0x1D,
	uint8Max, 0xF3, 0xF1, 0xEA, 0xF0, 0xF6, 0xEB, 0xE8, 0xF2, 0xF3, 0xFD, 0x12, 0x30, 0x40, 0x39, 0x19,
	...
	0x18, 0x2B, 0x29, 0x1E, 0x18, 0x08, 0x02, 0x0D, 0x0A, 0xF6, 0xFC, 0x13, 0x27, 0x17, uint8Max, 0xF3,
	0xEF, 0xF8, 0xF8, 0xE5, 0xE4, 0xF0, uint8Max, 0x15, 0x13, 0xFB, 0xF1, 0x09, 0x24, 0x28, 0x19, 0x17,
	0x0E, 0x01, 0xFD, 0xF6, 0xF5, 0x06, 0x00, 0xEC, 0xD1, 0xBC, 0xCC, 0xF9, 0x1E, 0x1C, uint8Max, 0xEB,
	...
	0xF5, uint8Max, 0xFD, 0x10, 0x2C, 0x3E, 0x43, 0x2A, 0xFA, 0xDA, 0xD8, 0xDD, 0xD1, 0xC1, 0xCD, 0xE1,
	0xF6, 0x12, 0x1F, 0x29, 0x39, 0x32, 0x18, 0xEF, 0xCB, 0xC8, 0xE0, 0xF8, 0xFA, 0xF3, uint8Max, 0x19,
	...
	0xEA, 0xE2, 0xE1, 0xED, 0xFD, 0x12, 0x13, 0x04, 0xFE, 0x0A, 0x19, 0x18, 0x05, 0x00, uint8Max, 0xFA,
	0x01, 0xFD, 0xF7, 0x04, 0x0A, uint8Max, 0xE6, 0xCA, 0xCE, 0xE4, 0xFE, 0x09, 0x00, 0xFB, 0x02, 0xFE,
	...
	0xFD, 0x11, 0x2A, 0x37, 0x3B, 0x23, uint8Max, 0xEF, 0xEF, 0xED, 0xD6, 0xB4, 0xAD, 0xC6, 0xE6, 0x12,
	...
	0x14, 0x13, 0x0D, 0x0C, 0xFB, 0xEF, 0xF4, 0x0C, 0x2D, 0x31, 0x15, uint8Max, 0xE9, 0xED, 0xFE, 0xFD,
	0xF7, 0xF3, 0xF2, 0xFD, 0x01, 0x00, 0x0A, 0x16, 0x24, 0x25, 0x12, 0x0B, 0x06, 0xFA, 0xF9, 0xE9,
	0xE1, 0xEF, 0xFE, 0x00, 0xF2, 0xDC, 0xE0, 0xEB, 0xF5, 0xFB, 0xF3, 0xF0, uint8Max, 0xFB, 0xF7, 0xF8,
	0xF3, 0x03, 0x0C, 0xFE, 0xEF, 0xE8, 0xF8, 0x1C, 0x23, 0x21, 0x10, 0xFA, 0xF3, 0xE6, 0xCE, 0xD1,
	0xE1, uint8Max, 0x1C, 0x1A, 0x0F, 0x0B, 0x19, 0x34, 0x36, 0x17, 0xFD, 0xE1, 0xE2, 0xF8, 0x05, 0x14,
	...
	0xF2, 0xF3, 0xF1, 0xED, 0xFC, 0x08, 0x18, 0x1E, 0x0B, uint8Max, 0x00, 0x01, 0x04, 0xF7, 0xEA, 0xEC,
	0xFB, 0x00, 0xF8, 0xEF, 0xF0, 0xF7, 0xF7, 0xF7, 0xEB, 0xEC, uint8Max, 0x0B, 0x04, 0xF8, 0xE9, 0xEE,
	0xF7, 0xF7, 0xEE, 0xEB, 0xF7, 0x10, 0x1D, 0x22, 0x1E, 0x0E, 0x04, 0xF8, 0xDE, 0xD0, 0xE0, uint8Max,
	...
	0xFC, 0xF7, uint8Max, 0x0F, 0x24, 0x34, 0x2C, 0x15, 0x04, 0x03, 0x13, 0x17, 0x01, 0xF1, 0xEC, 0xEA,
	...
	0xCB, 0xC3, 0xCA, 0xE9, 0x0C, 0x21, 0x1E, 0x11, 0x10, 0x0B, 0xFE, 0xF9, uint8Max, uint8Max, 0xFB, uint8Max,
	...
	0xFD, uint8Max, 0x01, 0x03, 0x06, 0x08, 0x07, 0x06, 0xFB, 0xE6, 0xDF, 0xF2, 0x07, 0x17, 0x20, 0x1D,
	...
	0x20, 0x1A, 0x1F, 0x19, 0x11, 0x0D, 0x10, 0x17, 0x11, 0xFE, 0xF6, 0xF4, 0xF2, 0xF6, uint8Max, 0xFE,
	0xF9, 0xF5, 0xF9, uint8Max, 0xF5, 0xF4, 0xFA, 0xFC, 0xFE, 0xFB, uint8Max, 0x0B, 0x0C, 0x0A, 0x0B, 0x02,
	...
	0xF7, 0xF3, 0xF0, 0xE3, 0xE9, 0xFA, 0x04, 0x02, 0xF5, 0xEF, 0xF5, uint8Max, 0x08, 0x0B, 0xFD, 0xEA,
	...
	0x09, 0x06, 0x05, 0x0C, 0x14, 0x18, 0x0F, 0xFA, 0xE9, 0xEA, 0xF3, 0x01, 0x05, uint8Max, 0xF7, 0xF7,
	...
	0x01, 0x06, 0x09, 0x09, 0x09, 0x04, 0xF1, 0xE5, 0xE9, 0xFC, 0x11, 0x19, 0x11, uint8Max, 0xF7, 0x00,
	0x04, 0x02, 0x01, 0x09, 0x17, 0x1F, 0x1B, 0x0A, 0x03, 0x01, 0x07, 0x0A, 0x09, 0x05, 0x01, uint8Max,
	...
	0xFE, uint8Max, uint8Max, 0x06, 0x0D, 0x04, 0xF7, 0xF8, 0x09, 0x1F, 0x29, 0x23, 0x12, 0x09, 0x09, 0x07,
	0xFD, 0xFD, 0x06, 0x10, 0x14, 0x03, 0xE9, 0xE2, 0xEE, 0x00, 0x09, 0x04, uint8Max, 0x00, 0x09, 0x0F,
	0x01, 0xF7, uint8Max, 0x06, 0x05, 0xF9, 0xEB, 0xEC, 0x03, 0x13, 0x13, 0x04, 0xF1, 0xE5, 0xDD, 0xDD,
	...
	0x04, 0x0E, 0x1C, 0x27, 0x22, 0x06, 0xF7, 0xF9, 0xFE, 0x02, 0x00, 0xFC, 0xFA, uint8Max, 0xFE, 0xF2,
	...
	0x0B, 0x0A, 0xF8, 0xDF, 0xD4, 0xEE, 0x0C, 0x13, 0x11, 0x07, 0xF9, 0xF1, 0xF3, 0xF7, uint8Max, 0x0D,
	0x1B, 0x06, 0xE1, 0xCD, 0xCF, 0xE6, 0x00, 0x01, 0xF5, 0xF3, 0xFA, 0x03, 0x05, 0x05, 0xFD, 0xF9,
	0x01, 0xFD, 0xEA, 0xF3, 0x12, 0x2C, 0x35, 0x28, 0x10, 0x04, 0x03, 0x06, uint8Max, 0xF7, 0xFA, 0x06,
	0x15, 0x15, 0xFD, 0xEE, uint8Max, 0x09, 0x06, 0x00, 0xFC, 0xFE, 0x08, 0x09, 0xFB, 0xEE, 0xF3, 0x05,
	...
	0xF4, 0xEB, 0x04, 0x15, 0x0D, 0x01, 0xF9, 0x02, 0x11, 0x14, 0x04, 0xF0, 0xED, uint8Max, 0x07, 0x03,
	...
	0xF7, 0x03, 0x0C, uint8Max, 0xF2, 0xEC, 0xF3, 0x04, 0x10, 0x0B, 0xFD, 0xF7, 0xFE, 0x00, 0xF9, 0xE8,
	...
	0x10, 0x21, 0x1A, 0xFD, 0xE6, 0xE4, 0xF4, 0x09, 0x19, 0x25, 0x28, 0x26, 0x1C, 0x02, 0xF2, uint8Max,
	...
	0x13, uint8Max, 0xE9, 0xE2, 0xF1, 0x06, 0x19, 0x27, 0x2A, 0x25, 0x1E, 0x0A, 0xFC, 0x04, 0x11, 0x0D,
	...
	0x05, uint8Max, 0xF2, 0xE9, 0xE9, 0xF4, 0x04, 0x13, 0x19, 0x07, 0xF3, 0xEF, uint8Max, 0x10, 0x12, 0x03,
	...
	0x13, uint8Max, 0xE9, 0xE0, 0xE2, 0xEA, 0xF4, 0xF7, 0xEE, 0xE7, 0xF5, 0x17, 0x37, 0x40, 0x2F, 0x15,
	...
	0xED, 0xFD, 0x18, 0x2A, 0x30, 0x2B, 0x22, 0x16, 0x09, 0x07, 0x0A, 0x0A, uint8Max, 0xEF, 0xEA, 0xF6,
	...
	0xFD, 0x05, 0x07, 0x01, 0xFB, uint8Max, 0x08, 0x12, 0x1A, 0x22, 0x23, 0x17, 0x03, 0xF7, 0xF7, 0xFE,
	0x04, uint8Max, 0xF6, 0xF0, 0xF8, 0x06, 0x10, 0x0E, 0x05, 0xFD, 0xF9, 0xF5, 0xEC, 0xE9, 0xEB, 0xEE,
	0xEE, 0xED, 0xEF, 0xFA, 0x08, 0x12, 0x0D, 0xFD, 0xF0, 0xEF, 0xF8, 0xFE, 0xFA, 0xF3, 0xEB, 0xE9,
	0xEA, 0xF3, uint8Max, 0x06, 0x0D, 0x0A, 0x00, 0xF3, 0xF4, 0x02, 0x0C, 0x0A, 0xFB, 0xEE, 0xF1, 0x03,
	0x19, 0x28, 0x2A, 0x24, 0x19, 0x11, 0x09, 0x06, 0x03, 0x05, 0xFC, 0xED, 0xE7, 0xF4, 0x0B, 0x22,
	0x26, 0x17, 0x00, 0xF3, 0xF6, 0xFD, uint8Max, 0xF0, 0xE3, 0xDE, 0xE7, 0xF6, 0x0B, 0x1B, 0x20, 0x13,
	uint8Max, 0xF0, 0xE8, 0xEB, 0xF1, 0xED, 0xDC, 0xD4, 0xDA, 0xF5, 0x10, 0x1F, 0x1B, 0x0D, 0xFA, 0xEE,
	...
	uint8Max, 0xF2, 0xF6, 0xFE, 0x04, 0xF8, 0xE4, 0xDC, 0xE0, 0xF1, 0x0B, 0x1D, 0x23, 0x17, 0x01, 0xF1,
	...
	0xFB, 0xF7, 0x02, 0x18, 0x28, 0x2D, 0x2A, 0x1A, 0x05, 0xF6, 0xF1, 0xFB, 0x01, uint8Max, 0xF3, 0xE7,
	...
	0xF2, 0x01, 0x0C, 0x05, 0xEB, 0xD8, 0xDA, 0xEC, 0x06, 0x1B, 0x1F, 0x13, uint8Max, 0xF1, 0xE7, 0xE7,
	...
	0x18, 0x0B, 0xF5, 0xE4, 0xE5, 0xF5, uint8Max, 0xFB, 0xF0, 0xE5, 0xE6, 0xF1, uint8Max, 0x0A, 0x09, 0x09,
	...
	0xF5, uint8Max, 0x11, 0x20, 0x25, 0x1B, 0x0A, 0x02, 0x03, 0x0C, 0x10, 0x03, 0xF4, 0xEC, 0xF5, 0x0F,
	...
	0xF7, 0xE5, 0xE1, 0xEF, 0xFD, uint8Max, 0xF8, 0xF3, 0xF3, 0xF5, 0xF8, 0xFD, 0xFD, 0x00, 0x03, 0xFC,
	...
	0xF4, 0xDC, 0xD7, 0xE6, 0xF9, 0x09, 0x12, 0x13, 0x08, 0xFD, 0xF3, 0xEE, 0xF8, 0x04, uint8Max, 0xEA,
	...
	0xE0, 0xE8, 0xF6, 0xFD, 0xFA, 0xF7, 0xF8, 0xFB, 0xFE, uint8Max, 0xFE, 0x00, 0x05, 0x02, 0xF4, 0xED,
	0xF5, 0x01, 0x05, 0xFE, 0xF9, uint8Max, 0x0F, 0x1B, 0x19, 0x0B, 0x00, 0x00, 0x0D, 0x1A, 0x1A, 0x13,
	0x0E, 0x09, uint8Max, 0xFB, 0x01, 0x10, 0x1C, 0x1A, 0x04, 0xEB, 0xE8, 0xFB, 0x0C, 0x0E, 0xF8, 0xE0,
	0xD8, 0xE3, 0xF5, 0x05, 0x11, 0x14, 0x0E, uint8Max, 0xF3, 0xE9, 0xF0, 0xFE, 0x03, 0xF3, 0xE3, 0xE1,
	0xF0, 0x03, 0x0E, 0x09, 0xFD, 0xF6, 0xF1, 0xED, 0xEA, 0xE7, 0xE9, 0xF6, 0xFD, 0xFD, uint8Max, 0x0B,
	0x16, 0x18, 0x11, 0x08
])

const _musicDataSample4 = Uint8Array.from([
	0x01, 0xF8, 0x00, 0x40, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x0E, 0x0D, 0xF4, 0x0F, uint8Max, 0x0C,
	...
	0x0E, 0xE3, 0x11, 0x2B, 0x26, 0x23, 0x21, 0x18, uint8Max, 0x11, 0x0C, 0x08, 0x07, 0x05, 0x06, 0x0A,
	...
	0x04, uint8Max, 0x0C, 0x10, 0x11, 0x1D, 0x1A, 0x0A, 0x06, 0x0E, 0x00, 0x07, 0x16, 0x12, 0x0F, 0x0F,
...
const _musicDataSample6 = Uint8Array.from([
	...
	0x13, 0x1A, 0x3A, 0x32, 0x1F, 0x3B, 0x42, 0x4F, 0x3C, 0x2E, 0x08, 0x14, uint8Max, 0xE7, 0xF0, 0xF6,
	0x0D, 0xF5, 0x0E, 0xFE, 0x08, 0x05, 0xDD, 0xC4, 0xC9, 0xB1, 0xB7, 0xCC, 0xE6, 0xF8, 0x0D, 0x20,
	uint8Max, 0x3A, 0x40, 0x4F, 0x2F, 0x57, 0x4C, 0x4A, 0x39, 0xF6, 0xF4, 0xDA, 0xD1, 0xBF, 0xD4, 0xE8,
	...
	0xE6, 0xF8, 0x1B, 0xF0, 0xE7, 0xE0, 0xCC, 0xC6, 0xCF, 0xEC, uint8Max, 0x25, 0x2D, 0x20, 0x23, 0x37,
	...
	uint8Max, 0xF3, 0xF5, 0xDC, 0xE0, 0xC2, 0xCB, 0xD2, 0xED, 0x07, 0x2D, 0x2A, 0x22, 0x32, 0x2C, 0x26,
	...
	0xC1, 0xD6, 0xE9, uint8Max, 0x0D, 0x14, 0x1D, 0x2B, 0x1E, 0x24, 0x2A, 0x35, 0x48, 0x52, 0x4A, 0x3E,
	...
	0xF1, 0xE5, 0xE1, 0xE1, 0xEF, 0xF5, 0xF7, uint8Max, 0xF8, 0xF2, 0xE0, 0xCC, 0xC8, 0xD7, 0xE3, 0xEF,
	uint8Max, 0x0D, 0x17, 0x1F, 0x1D, 0x1B, 0x25, 0x3A, 0x3B, 0x43, 0x4D, 0x3E, 0x30, 0x19, 0x04, 0xF6,
	...
	0x05, 0x12, 0x1B, 0x1D, 0x16, 0x22, 0x33, 0x36, 0x41, 0x4B, 0x46, 0x38, 0x26, 0x0C, uint8Max, 0xF2,
	0xEA, 0xDF, 0xE5, 0xEF, 0xF3, 0xF9, uint8Max, 0xFB, 0xF6, 0xE1, 0xCC, 0xCB, 0xD4, 0xDF, 0xEB, 0xFD,
	...
	0xE2, 0xE3, 0xE9, 0xF0, 0xF6, 0xFD, 0xFC, 0xFB, 0xEE, 0xD5, 0xCB, 0xCE, 0xD8, 0xE3, 0xF3, uint8Max,
	...
	0xE7, 0xEA, 0xF2, 0xF7, 0xFB, 0xFD, 0xF8, 0xE1, 0xD3, 0xCB, 0xD0, 0xD7, 0xE7, 0xF2, uint8Max, 0x12,
	...
	0xEB, 0xEF, 0xF7, 0xF8, uint8Max, 0xFA, 0xEA, 0xD8, 0xD0, 0xCD, 0xD4, 0xE0, 0xEC, 0xF7, 0x0C, 0x15,
	0x12, 0x19, 0x1D, 0x26, 0x30, 0x3E, 0x47, 0x49, 0x44, 0x32, 0x1E, 0x0F, 0xFE, 0xF0, 0xE8, 0xE7,
	0xEA, 0xF2, 0xF5, 0xFA, uint8Max, 0xF8, 0xE6, 0xD6, 0xCF, 0xCD, 0xD5, 0xE3, 0xEB, 0xFB, 0x0F, 0x12,
...
const _musicDataSample7 = Uint8Array.from([
	...
	0x11, 0x16, 0x08, 0x0B, 0x17, 0xFA, 0x0E, 0x17, 0x06, 0x0F, 0x0F, 0x13, 0x11, 0xFA, 0x28, uint8Max,
	0x0E, 0x23, 0xFD, 0x14, 0x1F, 0xF2, 0x1C, 0x0F, 0x00, 0x37, 0xF7, 0x04, 0x1B, 0xF3, 0x1C, 0x0F,
	0x06, 0x0F, 0x12, uint8Max, 0x14, 0x0D, 0x10, 0x0B, 0xF4, 0x4F, 0xCF, 0x28, 0xEA, 0x2B, uint8Max, 0x10,
	0x2F, 0xE4, 0x13, uint8Max, 0x12, 0x0F, 0x16, 0x07, 0x2F, 0xD4, 0x24, uint8Max, 0x00, 0x18, 0x11, 0x00,
	0x17, 0x02, 0x11, 0xFA, 0x2F, 0xEA, 0x18, uint8Max, 0x0C, 0x04, 0x30, uint8Max, 0x24, 0xE3, 0x30, uint8Max,
	...
	0x0C, 0xF2, 0x34, uint8Max, 0xF8, 0x19, 0x13, 0x09, 0xFC, 0x55, 0xAF, 0x10, 0x37, 0xD2, 0x31, 0x08,
	...
	0xE1, 0x2C, uint8Max, 0x0A, 0x1F, 0x06, uint8Max, 0x00, 0x2F, 0xEB, 0x1A, 0x08, 0x2B, 0xDB, 0x20, 0x1B,
	0xE8, 0x30, 0xF7, 0x08, 0x23, 0xEF, 0x20, uint8Max, 0x27, 0xFB, 0x12, 0x0A, 0x15, 0xFE, 0x0E, 0x17,
	0x11, 0xF7, 0x11, 0x09, 0x15, uint8Max, 0x10, 0x1F, 0xEA, 0x1A, 0x0C, uint8Max, 0x19, 0x1C, uint8Max, 0x15,
	0x06, 0x05, 0x11, 0x19, 0xFA, 0x12, 0x0B, 0x04, 0x1B, 0x0E, 0x04, 0x13, 0x15, uint8Max, 0x04, 0x27,
	0xEC, 0x24, uint8Max, 0x00, 0x2B, 0xE6, 0x20, 0x08, 0x06, 0x0B, 0x08, 0x1B, 0x00, 0x1C, 0x0B, 0x04,
	0x09, 0x0C, 0x0F, 0x06, 0x0C, 0x13, 0x07, 0x03, 0x1F, 0xF3, 0x20, 0x0D, 0xF8, 0x20, 0x0B, 0xF8,
	0x26, uint8Max, 0x14, 0x0F, 0x09, 0x09, 0x0E, 0x1B, 0xE4, 0x40, 0xF7, 0x00, 0x22, uint8Max, 0x11, 0x00,
	0x2B, 0xFA, 0x0A, 0x11, 0x16, 0x03, 0x0C, 0x1B, 0xFC, 0x07, 0x08, 0x1F, 0xE2, 0x40, 0xFB, 0x00,
	0x23, 0xFB, 0x10, 0x16, 0x05, 0x12, 0x06, 0x06, 0x2C, 0xEF, 0x10, 0x17, 0xF8, 0x20, uint8Max, 0x10,
	0x0A, 0x0B, 0x12, 0x05, 0x17, 0x0C, 0x0D, 0x08, 0x0E, 0x12, 0x08, 0x17, 0x05, 0x0C, 0x0F, 0x04,
	0x10, 0x15, 0x04, 0x1D, 0xEF, 0x2C, uint8Max, 0x00, 0x1F, 0x03, 0x12, 0x08, 0x09, 0x18, 0x0B, 0x00,
	0x1E, uint8Max, 0x08, uint8Max, 0x2C, 0xFD, 0x08, 0x1F, 0xF2, 0x14, 0x17, 0xF4, 0x2D, uint8Max, 0x02, 0x2F,
	0xF0, 0x07, 0x10, 0x17, 0xFD, 0x20, uint8Max, 0x0C, 0x0E, 0x06, 0x08, 0x19, 0xFB, 0x12, 0x17, 0xF8,
	0x18, 0x0B, 0x17, 0xF8, 0x16, 0x07, 0x0C, 0x13, 0x08, 0x07, 0x04, 0x0F, 0x09, 0x10, 0x08, 0x1F,
	0xEC, 0x18, 0x17, 0xF8, 0x1F, 0x05, 0x04, 0x17, uint8Max, 0x18, 0x0F, 0x08, 0x0C, 0x08, 0x10, 0x04,
	...
	0x30, uint8Max, 0x08, 0x1C, 0xEF, 0x18, 0x08, 0x13, 0x09, 0x0C, 0x17, 0xF0, 0x28, 0x07, 0x08, 0x1D,
	0xFD, 0x10, 0x15, 0xFD, 0x28, uint8Max, 0x04, 0x1C, 0xF7, 0x18, 0x07, 0x1E, 0x07, 0x08, 0x17, 0xF4,
	0x1C, 0x07, 0x0B, 0x0C, 0x1A, 0x06, 0x06, 0x19, 0x04, 0x10, 0x04, 0x14, 0x07, 0x0A, 0x1F, 0xEE,
	0x28, uint8Max, 0x09, 0x0F, 0x10, 0x07, 0x08, 0x18, 0x02, 0x14, 0x00, 0x1C, 0x05, 0x0B, 0x06, 0x1F,
	0xEF, 0x18, 0x0F, 0x0C, 0x0E, 0x06, 0x13, 0x02, 0x0D, 0x14, 0x04, 0x13, 0x0B, 0x0F, 0x04, 0x1B,
	uint8Max, 0x0C, 0x13, 0x06, 0x0E, 0x0E, 0x0F, 0x09, 0x0B, 0x0E, 0x06, 0x12, 0x0B, 0x0A, 0x11, 0x0B,
	0x09, 0x0C, 0x0E, 0x07, 0x11, 0x08, 0x11, 0x0F, 0x09, 0x0C, 0x17, 0xFA, 0x1A, 0x07, 0x16, uint8Max,
	0x18, 0x0F, 0x02, 0x17, 0x05, 0x10, 0x04, 0x19, 0x06, 0x11, 0x02, 0x1D, uint8Max, 0x08, 0x1B, 0xFE,
	0x18, 0x0A, 0x11, 0x07, 0x14, 0x0E, 0x0C, 0x0D, 0x0D, 0x0E, 0x03, 0x16, 0x09, 0x10, 0x03, 0x1A,
	0x06, 0x08, 0x1B, uint8Max, 0x11, 0x0B, 0x0A, 0x0E, 0x0A, 0x0F, 0x06, 0x16, 0x06, 0x06, 0x15, 0x05,
