...
const _gameLevels = [
	...
	{ name: "level3", name2: "level3", nameAmiga: "dt", cutscene_id: 0xFFFF, sound: 3, track: 5 },
	...
	{ name: "level5", name2: "level5_2", nameAmiga: "level4_2", cutscene_id: 0xFFFF, sound: 4, track: 7 }
]
...
const _protectionNumberDataAmiga = Uint8Array.from([
...
const _protectionCodeDataAmiga = Uint8Array.from([
