...
function printUsage() {
    console.error("Usage: npx ts-node --transpile-only ./src/debugger-helpers/export-bnq-image.ts <bnq> <output.ppm> [pal] [paletteSlot] [tilesPerRow]")
}
...
function main() {
    ...
    BnqImageExporter.exportTilesImage(bnqPath, outputPath, palettePath || undefined, paletteSlot, tilesPerRow)
