...
function printUsage() {
    console.error("Usage:")
    console.error("  npx ts-node --transpile-only ./src/debugger/sprites/export-sprite-image.ts <spr> <off> <spriteIndex> <paletteRef> <output.png> [flags]")
    console.error("  npx ts-node --transpile-only ./src/debugger/sprites/export-sprite-image.ts <spr> <off> all <paletteRef> <outputDir> [flags]")
